          ...
          {isSidebarOpen && (
            ...
            >
              <div className="p-4 border-b border-neutral-800 flex justify-between items-center">
                ...
                <button className="text-emerald-500 hover:text-emerald-400"><Plus className="w-4 h-4" /></button>
              </div>
              ...
              <div className="flex-1 overflow-y-auto p-2 space-y-1">
                {accounts.length === 0 ? (
                  <div className="p-8 text-center">
                    ...
                    <p className="text-xs text-neutral-600 italic">Nenhuma conta salva ainda. Faça login em um site para salvar.</p>
                  </div>
                ) : (
                  accounts.map((acc: Account) => (
                    <div key={acc.id} className="group p-3 hover:bg-neutral-800 rounded-xl transition-all cursor-pointer border border-transparent hover:border-neutral-700">
                      <div className="flex items-center gap-3">
                        ...
                        <button className="opacity-0 group-hover:opacity-100 p-1.5 hover:bg-neutral-700 rounded-lg text-neutral-500 transition-all">
